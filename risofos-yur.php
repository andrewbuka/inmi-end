		...
		<div class="container">
			<div class="row ">
				<div class="col-12 col-md-4">
					<br>
					<br>
                    <i>(Марки «Галега», «Люцерна», «Клевер»)</i><br>
					<span style="background: rgba(255, 217, 16, 1);">
					

Микробные препараты для предпосевной обработки семян и вегетирующих растений многолетних бобовых трав с целью повышения их продуктивности
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img style="max-width: 300px;" src="http://inmi/wp-content/uploads/2026/06/risofos-Photoroom.png" alt="img">
