			...
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					<span style="background: rgba(255, 217, 16, 1);">
						Препарат микробный для обработки семян и вегетирующих растений сахарной свеклы с целью повышения продуктивности сахарной свеклы
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img src="http://inmi/wp-content/uploads/2026/06/cudamik-Photoroom.png" alt="img">
					
				</div>
				<div class="col-12 col-md-3 single-shop-left my-single-shop-left single-fiz-product" data-product-id="fiz-9">
					...
					<div class="single-price my-single-price">
						<div class="new-price">9.90 BYN</div>
					</div>
		...
		<div class="container">
			<div class="tab-wrap">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab2">
						<div class="faq-item">
							<h5 class="title"><span><a href="http://inmi/wp-content/uploads/2026/07/cudamik-instr.pdf">Инструкция по применению - открыть и скачать</a></span></h5>
						</div>
					</div>
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.187-2024</i></span></h5>
					</div>
				</div>
			</div>
		</div>
