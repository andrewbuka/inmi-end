<?php
    ...
    $inmi_knowledge_articles = [
        ...
        [
            'url' => '/news-about-bee/',
            'title' => 'Как подготовить пчел к зимовке и главному медосбору. Инвертная подкормка',
            'category' => 'Пчеловодство',
            'summary' => 'Рассказываем, зачем пчёлам нужны инвертные сахарные подкормки, когда применять сироп и канди, и как ферментная добавка «Апифил» помогает пасеке.',
        ],
    ];
?>
<?php get_header(); ?>
