		...
		<div class="container">
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					Микробный препарат для обработки корневой системы микроклональных растений, почвы и саженцев при пересадке в открытый грунт, вегетирующих древесно-кустарниковых видов растений рода Vaccinium (голубика, брусника, клюква)
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img style="max-width: 300px;" src="http://inmi/wp-content/uploads/2026/06/maklor-Photoroom-1.png" alt="img">
				...
				<div class="col-12 col-md-3 single-shop-left my-single-shop-left single-yur-product">
					...
					<div class="frame-size">
						...
						<ul>
							<li class="active my-active">до 20 л</li>
		...
		<div class="container">
			<div class="tab-wrap">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab2">
						<div class="faq-item">
							<h5 class="title"><span><a target="_blank" href="http://inmi/wp-content/uploads/2026/06/maklor-instr.pdf">Инструкция по применению - открыть и скачать</a></span></h5>
						</div>
					</div>
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.105-2013 </i></span></h5>
						</div>
					</div>
			</div>
		</div>
