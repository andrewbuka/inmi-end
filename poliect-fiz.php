		...
		<div class="container">
			<div class="row ">
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img src="http://inmi/wp-content/uploads/2026/05/poliekt.png" alt="img">
					
				</div>
				<div class="col-12 col-md-3 single-shop-left my-single-shop-left single-fiz-product" data-product-id="fiz-2">
					...
					<div class="single-price my-single-price">
						<div class="new-price">25 BYN</div>
					</div>
