		...
		<div class="container">
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					Биопрепарат для очистки сточных вод и абсорбционных растворов от фенола и формальдегида
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img style="max-width: 300px;" src="http://inmi/wp-content/uploads/2026/06/fenoform-Photoroom.png" alt="img">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.144-2018</i></span></h5>
						</div>
					</div>
			</div>
		</div>
