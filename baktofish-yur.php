		...
		<div class="container">
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					Микробное удобрение для улучшения естественной кормовой базы рыбоводных прудов, повышения продуктивности рыбы
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img style="max-width: 300px;" src="http://inmi/wp-content/uploads/2026/06/baktofish-Photoroom.png" alt="img">
		...
		<div class="container">
			<div class="tab-wrap">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab2">
						<div class="faq-item">
							<h5 class="title"><span><a target="_blank" href="http://inmi/wp-content/uploads/2026/06/baktofish-instr.pdf">Инструкция по применению - открыть и скачать</a></span></h5>
						</div>
					</div>
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.148-2018 </i></span></h5>
						</div>
					</div>
			</div>
		</div>
