			...
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					<span style="background: rgba(255, 217, 16, 1);">
						Живые лиофильно высушенные культуры родов Lactiplantibacillus, Lacticaseibacillus, Lentilactobacillus,Pediococcus, Propionibacterium; титр жизнеспособных клеток – не менее 1,25х1011 КОЕ/г. Штаммы способствует улучшению биодоступности, повышению переваримости, увеличению пищевой и энергетической ценности полученного корма
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img style="max-width: 300px;" src="http://inmi/wp-content/uploads/2026/06/lacsil-ms-2.png" alt="img">
				...
				<div class="col-12 col-md-3 single-shop-left my-single-shop-left single-yur-product">
					...
					<div class="frame-size">
						...
						<ul>
							<li class="active my-active">100 г</li>
		...
		<div class="container">
			<div class="tab-wrap">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab2">
						<div class="faq-item">
							<h5 class="title"><span><a target="_blank" href="http://inmi/wp-content/uploads/2026/07/instr-laksil-ms2.pdf">Инструкция по применению - открыть и скачать</a></span></h5>
						</div>
					</div>
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.190-2025</i></span></h5>
						</div>
					</div>
			</div>
		</div>
