			...
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					<span style="background: rgba(255, 217, 16, 1);">
						Микробный препарат для комплексной очистки сточных вод птицеперерабатывающих предприятий
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img style="max-width: 300px;" src="http://inmi/wp-content/uploads/2026/06/pf-complex.png" alt="img">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.175-2023</i></span></h5>
						</div>
					</div>
			</div>
		</div>
