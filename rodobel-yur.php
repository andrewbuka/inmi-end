		...
		<div class="container">
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					Биосорбционный препарат и его микробная составляющая
для очистки и рекультивации почвы от нефти и продуктов ее переработки
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img style="max-width: 300px;" src="http://inmi/wp-content/uploads/2026/06/rodobel-th-Photoroom.png" alt="img">
				...
				<div class="col-12 col-md-3 single-shop-left my-single-shop-left single-yur-product">
					...
					<div class="frame-size">
						...
						<ul>
                            ...
                            <li class="active my-active">1-50 кг</li>
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.097-2012</i></span></h5>
						</div>
					</div>
			</div>
		</div>
