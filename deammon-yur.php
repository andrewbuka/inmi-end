		...
		<div class="container">
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					Биопрепарат для интенсификации очистки коммунально-бытовых и сельскохозяйственных сточных вод,
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.135-2015</i></span></h5>
						</div>
					</div>
			</div>
		</div>
