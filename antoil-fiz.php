			...
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					<span style="background: rgba(255, 217, 16, 1);">
						Биоактиватор для биологических очистных сооружений любого типа. <br>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img src="http://inmi/wp-content/uploads/2026/05/antoil.png" alt="img">
					
				</div>
				<div class="col-12 col-md-3 single-shop-left my-single-shop-left single-fiz-product" data-product-id="fiz-1">
					...
					<div class="single-price my-single-price">
						<div class="new-price">15 BYN</div>
					</div>
		...
		<div class="container">
			<div class="tab-wrap">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab2">
						<div class="faq-item">
							<h5 class="title"><span><a href="http://inmi/wp-content/uploads/2026/06/antoil_instr.pdf">Инструкция по применению - открыть и скачать</a></span></h5>
						</div>
					</div>
