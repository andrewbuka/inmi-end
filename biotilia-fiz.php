			...
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					<span style="background: rgba(255, 217, 16, 1);">
						Микробное удобрение для минимизации негативного влияния противогололедных реагентов на городские насаждения и улучшения роста растений в условиях засоления
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img src="http://inmi/wp-content/uploads/2026/06/biotilia-Photoroom.png" alt="img">
					
				</div>
				<div class="col-12 col-md-3 single-shop-left my-single-shop-left single-fiz-product" data-product-id="fiz-10">
					...
					<div class="single-price my-single-price">
						<div class="new-price">14.40 BYN</div>
					</div>
					
					<div class="frame-size">
						<label>Форма выпуска:</label>
						<ul>
							<li class="active my-active">1 л</li>							
						</ul>
					</div>
		...
		<div class="container">
			<div class="tab-wrap">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab2">
						<div class="faq-item">
							<h5 class="title"><span><a href="http://inmi/wp-content/uploads/2026/07/biotilia-instr.pdf">Инструкция по применению - открыть и скачать</a></span></h5>
						</div>
					</div>
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.163-2020</i></span></h5>
					</div>
				</div>
			</div>
		</div>
