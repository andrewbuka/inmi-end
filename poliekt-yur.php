	...
	<section class="s-header-title">
		<div class="container">
			...
			<ul class="breadcrambs">
				<li><a href="http://inmi/yur-page/">Препараты для юр лиц</a></li>
				<li><?php the_title(); ?></li>
			</ul>
		</div>
	</section>
		...
		<div class="container">
			<div class="row ">
				<div class="col-12 col-md-4">
					...
					Кормовая добавка для повышения физического, метаболического и иммунного статуса сельскохозяйственных животных и птицы, их продуктивности
					</span>
				...
				<div class="col-12 col-md-3">
					<!--===== SLIDER-SINGLE-FOR =====-->
					<img style="max-width: 300px;" src="http://inmi/wp-content/uploads/2026/06/poliekt-Photoroom-1.png" alt="img">
				...
				<div class="col-12 col-md-3 single-shop-left my-single-shop-left single-yur-product">
					...
					<div class="frame-size">
						...
						<ul>
							<li class="active my-active">до 10 л</li>
                            <li class="active my-active">до 5 кг</li>
		...
		<div class="container">
			<div class="tab-wrap">
				...
				<div class="tabs-content my-row">
					...
					<div class="tab tab2">
						<div class="faq-item">
							<h5 class="title"><span><a target="_blank" href="http://inmi/wp-content/uploads/2026/06/polie-instr-chicken.pdf">Инструкция по применению (цыплята)- открыть и скачать</a></span></h5>
							<h5 class="title"><span><a target="_blank" href="http://inmi/wp-content/uploads/2026/06/polie-instr-krs.pdf">Инструкция по применению (телята)- открыть и скачать</a></span></h5>
						</div>
					</div>
					...
					<div class="tab tab3">
						<div class="faq-item">
							...
							<h5 class="title"><span>Нормативно-технический документ - <i>ТУ РБ 100289066.158-2019</i></span></h5>
						</div>
					</div>
			</div>
		</div>
